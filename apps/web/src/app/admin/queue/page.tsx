  ...
  return (
    <AppShell role="admin" eyebrow="Admin" title="Queue">
      <section className="panel"><div className="panel-head"><div><p className="section-kicker">Task queue</p><h2>AI request queue</h2><p>Monitor pending tasks dan priority queue untuk AI gateway.</p></div></div>
        <div className="readiness-list"><span><i className="ready" /><strong>Normal</strong><small>0 pending tasks</small></span><span><i className="ready" /><strong>Wallet queue</strong><small>Provider work is gated by wallet reservation</small></span></div>
      </section>
    </AppShell>
  );
}
