  ...
  return (
    <AppShell eyebrow="Profile" title="Your account">
      <section className="panel form-panel"><div className="panel-head"><div><p className="section-kicker">Account details</p><h2>Profile settings</h2><p>Kelola nama, email, dan keamanan akun kamu di satu tempat.</p></div></div>
        <div className="form-grid"><label className="field-label">Name<input defaultValue="Andra Irawan" /></label><label className="field-label">Email<input type="email" defaultValue="andra@cliper.ai" /></label><label className="field-label">Password<input type="password" defaultValue="••••••••" disabled /></label><label className="field-label">Plan<select defaultValue="Pro"><option>Starter</option><option>Pro</option><option>Enterprise</option></select></label></div>
      </section>
