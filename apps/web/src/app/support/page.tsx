...
export default function SupportPage() {
  return (
    <AppShell eyebrow="Support" title="Help center">
      <section className="panel"><div className="panel-head"><div><p className="section-kicker">Need support?</p><h2>Ask our team</h2><p>Gunakan support untuk masalah setup desktop key, models, atau billing.</p></div></div>
      ...
      <section className="panel"><div className="panel-head"><div><p className="section-kicker">Quick links</p><h2>Panduan penggunaan</h2><p>Mulai dari install sampai integrasi API key dengan Cliper Studio.</p></div></div>
        <div className="finance-grid"><span><small>1</small><strong>Generate desktop key</strong></span><span><small>2</small><strong>Copy ke Cliper Studio</strong></span><span><small>3</small><strong>Atur provider</strong></span><span><small>4</small><strong>Jalankan render</strong></span></div>
      </section>
    </AppShell>
  );
}
