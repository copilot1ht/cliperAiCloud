...
interface HealthPayload {
  ...
  midtrans: { mode: string; configuration: string; source: string; webhookUrl: string; finishRedirectUrl: string; apiReachability: string; lastWebhookAt: string | null; lastSuccessfulPaymentAt: string | null; failedWebhookCount: number; signatureVerification: string };
  warnings: string[];
  errors: string[];
}
